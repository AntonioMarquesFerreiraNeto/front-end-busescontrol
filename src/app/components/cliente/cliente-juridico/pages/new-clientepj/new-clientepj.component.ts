  ...
  submit() {
    ...
    this.clienteService.CreateClientePJ(data).subscribe({
      next: () => {
        ...
        this.clienteService.GetClientesAtivos(this.compartilhamento.getPaginaAtualClientePj(), true).subscribe((itens) => this.compartilhamento.autualizarClientePj(itens.clienteList));
